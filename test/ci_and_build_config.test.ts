...
if (fs.existsSync(buildAndroidWorkflowPath)) {
  ...
  assert(content.includes('lumen-v3.0.0-android-apk'), 'Names artifact lumen-v3.0.0-android-apk');
}
...
if (fs.existsSync(appJsonPath)) {
  ...
  assertEqual(appConfig.expo.version, '3.0.0', 'App version is "3.0.0"');
...
if (fs.existsSync(packageJsonPath)) {
  ...
  assertEqual(pkg.version, '3.0.0', 'Package version is "3.0.0"');
