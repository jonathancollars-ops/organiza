...
if (fs.existsSync(buildAndroidWorkflowPath)) {
  ...
  assert(content.includes('lumen-v3.1.3-android-apk'), 'Names artifact lumen-v3.1.3-android-apk');
}
...
if (fs.existsSync(appJsonPath)) {
  ...
  assertEqual(appConfig.expo.version, '3.1.3', 'App version is "3.1.3"');
...
if (fs.existsSync(packageJsonPath)) {
  ...
  assertEqual(pkg.version, '3.1.3', 'Package version is "3.1.3"');
