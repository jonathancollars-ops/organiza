...
if (fs.existsSync(buildAndroidWorkflowPath)) {
  ...
  assert(content.includes('lumen-v3.1.2-android-apk'), 'Names artifact lumen-v3.1.2-android-apk');
}
...
if (fs.existsSync(appJsonPath)) {
  ...
  assertEqual(appConfig.expo.version, '3.1.2', 'App version is "3.1.2"');
...
if (fs.existsSync(packageJsonPath)) {
  ...
  assertEqual(pkg.version, '3.1.2', 'Package version is "3.1.2"');
